...
const BADGES: BadgeDef[] = [
  ...
  { key: 'firstSeller', icon: Package, color: 'bg-teal-500/10 text-teal-600 border-teal-500/20', condition: c => c.totalListings >= 1 && c.totalListings < 5 },
  { key: 'activeSeller', icon: TrendingUp, color: 'bg-indigo-500/10 text-indigo-600 border-indigo-500/20', condition: c => c.totalListings >= 5 },
  { key: 'communicator', icon: MessageCircle, color: 'bg-sky-500/10 text-sky-600 border-sky-500/20', condition: c => c.totalMessages >= 10 && c.totalMessages < 50 },
  { key: 'superCommunicator', icon: MessagesSquare, color: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/20', condition: c => c.totalMessages >= 50 },
  { key: 'wellRated', icon: Star, color: 'bg-yellow-500/10 text-yellow-600 border-yellow-500/20', condition: c => c.avgRating >= 4 && c.reviewCount >= 3 && !(c.avgRating >= 4.5 && c.reviewCount >= 10) },
  { key: 'topSeller', icon: Trophy, color: 'bg-orange-500/10 text-orange-600 border-orange-500/20', condition: c => c.avgRating >= 4.5 && c.reviewCount >= 10 },
